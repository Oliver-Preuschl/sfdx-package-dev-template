...
Once the repository is created and the DEVHUB_AUTH_URL is set up the following functionalities are available.

| Name                                                |       Type       | Description                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| --------------------------------------------------- | :--------------: | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Scratch org generation                              | Automatic/Manual | A new scratch org gets automatically generated whenever a branch is created (excluding branches "master" and any branch starting with "no-scratch/" (workflow "system:scratch-org:create [create:feature]"). Additionally, the workflow "system:scratch-org:create [create:feature]" can be used to display the scratch org login URL. If the scratch org is not available or has already expired, a new one will be automatically generated. |
...
| Documentation                                       | Automatic/Manual | Whenever a new package version gets created, the README.md will be automatically updated with a list of the available package versions and an ERD diagram of the included SObjects. Additionally, whenever a new scratch org gets created, it will be added to the list of scratch orgs. The README.md generation can also be executed by manually executing the workflow `"user:readme:build [master]"`                                      |
